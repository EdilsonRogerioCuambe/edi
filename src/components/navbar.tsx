        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="md:flex md:space-x-4 md:items-center md:justify-center hidden">
            ...
            <form onSubmit={handleSearch} className="flex items-center">
              ...
              <Button
                type="submit"
                className="p-2 ml-2 border-2 border-[#333333] text-[#333333] dark:border-[#f5f5f5] dark:text-[#f5f5f5] bg-white dark:bg-zinc-800 rounded transition-all duration-300 ease-in-out hover:bg-[#333333] dark:hover:bg-[#f5f5f5] hover:text-[#f5f5f5] dark:hover:text-[#333333]"
              >
                <Search size={20} />
              </Button>
            </form>
